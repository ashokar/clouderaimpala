...
public class TestHiveServer2MetaData {
...
static String QUERY = "SELECT description FROM default.sample_07";
...
public static class MyCallbackHandler implements CallbackHandler {
    ...
    // Print the result set.
    private static void  traverseResultSetMetaData(ResultSet rs) throws SQLException
    {
        ResultSetMetaData metaData = rs.getMetaData();
